#!/bin/bash
#SBATCH --job-name=batch_svhet                 # 1. Job name
...
time /lustre1/g/paed_yangwl/snakesch/work/SVhet/core/svhet/svhet.sh \
        ...
        --sv-vcf /lustre1/g/paed_yangwl/snakesch/data/svhet2/1kg/sv/lumpy/final_lumpy_gt-smoove.genotyped.vcf.gz \
        --outdir /lustre1/g/paed_yangwl/snakesch/tmp/test_svhet \
