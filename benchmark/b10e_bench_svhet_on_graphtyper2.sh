...
FINAL=/lustre1/g/paed_yangwl/snakesch/tmp/test_svhet/graphtyper2+svhet/final-annotated.vcf.gz

OUT="/lustre1/g/paed_yangwl/snakesch/tmp/test_svhet/graphtyper2+svhet/truvari"
