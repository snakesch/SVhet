...
FINAL=/lustre1/g/paed_yangwl/snakesch/tmp/test_svhet/duphold/final_lumpy_gt-smoove.genotyped.duphold.vcf.gz

OUT="/lustre1/g/paed_yangwl/snakesch/tmp/test_svhet/duphold/truvari"
...
bcftools view -s $sample $FINAL | bcftools filter -i '(SVTYPE="DEL" & FMT/GT = "het" & FMT/DHFFC[0] < 0.7)' -Wtbi -Oz -o $tmpdir/$sample-final.vcf.gz
