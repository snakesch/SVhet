...
FINAL=/lustre1/g/paed_yangwl/snakesch/tmp/test_svhet/duphold+svhet/final-annotated.vcf.gz

OUT="/lustre1/g/paed_yangwl/snakesch/tmp/test_svhet/duphold+svhet/truvari"
...
bcftools view -s $sample $FINAL | bcftools filter -i '(SVTYPE="DEL" & FMT/GT = "het" & FMT/DHFFC[0] < 0.7 & FMT/SVHET != "HIGH_HET")' -Wtbi -Oz -o $tmpdir/$sample-final.vcf.gz
