...
FINAL=/lustre1/g/paed_yangwl/snakesch/tmp/test_svhet/paragraph+svhet/final-annotated.vcf.gz

OUT="/lustre1/g/paed_yangwl/snakesch/tmp/test_svhet/paragraph+svhet/truvari"
...
bcftools view -s $sample $FINAL | bcftools filter -i '(SVTYPE="DEL" & FMT/GT = "het")' -Wtbi -Oz -o $tmpdir/$sample-final.vcf.gz
