#!/bin/bash
#SBATCH --job-name=svhet_on_paragraph                 # 1. Job name
...
time /lustre1/g/paed_yangwl/snakesch/work/SVhet/core/svhet/svhet.sh \
        ...
        --sv-vcf /lustre1/g/paed_yangwl/snakesch/tmp/test_svhet/paragraph/genotypes.vcf.gz \
        --outdir /lustre1/g/paed_yangwl/snakesch/tmp/test_svhet/paragraph+svhet \
